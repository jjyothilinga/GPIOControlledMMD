...
//Heart Beat
#define 	HEART_BEAT					PORTCbits.RC4
#define 	HEART_BEAT_DIRECTION		TRISCbits.TRISC4
...
#define		ROW_SEL_A				PORTAbits.RA1			// decoder digit sel A
#define		ROW_SEL_A_DIR			TRISAbits.TRISA1
#define		ROW_SEL_B				PORTAbits.RA2		// decoder digit sel B
#define		ROW_SEL_B_DIR			TRISAbits.TRISA2
#define		ROW_SEL_C				PORTAbits.RA3		// decoder digit sel C
#define		ROW_SEL_C_DIR			TRISAbits.TRISA3
#define		ROW_SEL_D				PORTAbits.RA4		// decoder digit sel D
#define		ROW_SEL_D_DIR			TRISAbits.TRISA4
#define		ROW_SEL_E				PORTAbits.RA5		// decoder digit sel E
#define		ROW_SEL_E_DIR			TRISAbits.TRISA5
#define		ROW_SEL_F				PORTEbits.RE0		// decoder digit sel F
#define		ROW_SEL_F_DIR			TRISEbits.TRISE0
#define		ROW_SEL_G				PORTEbits.RE1		// decoder digit sel G
#define		ROW_SEL_G_DIR			TRISEbits.TRISE1
#define		ROW_SEL_H				PORTAbits.RA0		// decoder digit sel G
#define		ROW_SEL_H_DIR			TRISAbits.TRISA0


// Keypad association
#define 	KEYPAD_PORT_0			PORTCbits.RC0
#define		KEYPAD_PORT_0_DIR		TRISCbits.TRISC0
#define 	KEYPAD_PORT_1			PORTCbits.RC1
#define		KEYPAD_PORT_1_DIR		TRISCbits.TRISC1
#define 	KEYPAD_PORT_2			PORTCbits.RC2
#define		KEYPAD_PORT_2_DIR		TRISCbits.TRISC2
#define 	KEYPAD_PORT_3			PORTCbits.RC3
#define		KEYPAD_PORT_3_DIR		TRISCbits.TRISC3
